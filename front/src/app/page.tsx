        ...
        <div className="w-[60%] h-full flex flex-col gap-8">
          <div className="w-full h-[65%]">
            <div className="flex flex-row items-end pb-5">
              <p className="font-semibold text-3xl text-gray-900 pr-2">Évènements</p>
              <Image src="https://em-content.zobj.net/source/apple/391/fire_1f525.png"
                   alt="Remote photo"
                   width={100}
                   height={100}
                   className="w-10 h-10"
          ...
          <div className="w-full h-[65%]">
                <div className="flex flex-row items-end pb-5">
                    <p className="font-semibold text-3xl text-gray-900 pr-2">Classement</p>
                    <Image src="https://em-content.zobj.net/source/apple/391/trophy_1f3c6.png"
                           alt="Remote photo"
                           width={100}
                           height={100}
                           className="w-10 h-10"
          ...
          <div className="w-full h-[35%]">
                ...
                <div className="flex flex-row items-end pb-5">
                    <p className="font-semibold text-3xl text-gray-900 pr-2">Évènements terminés</p>
                    <Image src="https://em-content.zobj.net/source/apple/391/door_1f6aa.png"
                           alt="Remote photo"
                           width={100}
                           height={100}
                           className="w-10 h-10"
